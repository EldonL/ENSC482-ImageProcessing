...
//Last Edited on 2018-08-06 5:20pm by Eldon Lin
//References
...
void searchForMovement(Mat thresholdImage, Mat &cameraFeed) {
	...
	for(int i=0; i<contours.size(); i++)
	{
		...
		if (shapeToShow.size() == 0)
		{
			name = "circle";
		}
		else if (shapeToShow.size() == 3)
		{
			name = "triangle";
		}
		else if (shapeToShow.size() == 4)
		{
			name = "square";
		}
		else if (shapeToShow.size() == 5)
		{
			name = "pentagon";
		}
		else if (shapeToShow.size() == 6)
		{
			name = "hexagon";
		}
		else if (shapeToShow.size() == 7)
		{
			name = "7 side gon";
		}
		else if (shapeToShow.size() == 8)
		{
			name = "octagon";
		}
		else
	...
	putText(cameraFeed, name, Point(x, y), 1, 1, Scalar(255, 0, 0), 2);
	}
...
int main() {
	...
	while (1) {
		...
		//if this is not included, we get a memory error!
			...
			Canny(thresholdImage, thresholdImage, 0, 2000, 5);
